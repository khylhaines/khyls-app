/* =========================================================
   qa_history.js
   HISTORY READING SYSTEM (PURE STORY MODE)
   - NO QUIZ
   - NO QUESTIONS
   - PIN BASED ONLY
========================================================= */
...
export function getHistoryReading(input = {}) {
  ...
  if (
    QA_HISTORY_READING &&
    QA_HISTORY_READING[pinId] &&
    QA_HISTORY_READING[pinId][tier]
  ) {
    return QA_HISTORY_READING[pinId][tier];
  }

  return [
    "Take a moment to look around… this place still has a story to tell."
  ];
}
